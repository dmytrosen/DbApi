...
*/
/* DBAPI metadata
	<DbApiMetadata method="GetProcClassResult" description="Get ProcClassResult">
		<ProcParams>
			<InParam name="paramRowID" type="int" />
			...
			<InParam name="paramDecimal" type="decimal(10,2)" nullable="true" description="Decimal parameter" />
			<InParam name="paramFloat" type="Float(37)" description="Float parameter" />
			...
			<OutParam name="outParamDecimal" type="Decimal(10,2)" nullable="true" description="Decimal output parameter" />
			<OutParam name="outParamFloat" type="Float(37)" nullable="false" description="Float output parameter" />
			...
			<InOutParam name="inOutParamDecimal" type="Decimal(10,2)" nullable="true" description="Decimal in-output parameter" />
			<InOutParam name="inOutParamFloat" type="Float(37)" nullable="false" description="Float in-output parameter" />
		...
		<ClassResult className="ProcClassResult" description="Class ProcClassResult">
			<ResultParams>
				<ResultParam name="ProcClassResultId" typeDef="dbo.ApiTestAllTypesTest.ApiTestAllTypesTesttID" />
				...
				<ResultParam name="resultDecimal" type="decimal(10,2)" nullable="true" description="Decimal return parameter" />
				<ResultParam name="resultFloat" type="Float" description="Float return parameter" />
...
DECLARE @outParamUpdatedBy INT, @outParamBigInt BigInt, @outParamBinary Binary(512), @outParamBit Bit, @outParamChar Char(10), 
	@outParamDateTime DateTime, @outParamDecimal decimal(10,2), @outParamFloat Float, @outParamInt Int, @outParamMoney Money, 
	...
	@inOutParamDecimal decimal(10,2) = 125, 
...
EXEC dbo.sp_ProcClassResult 2, 1234567893, 7, 1, 'A', '2017-05-31 10:11:24.970', 50.05, 1.005, 
